...
mongoose.connect(
  "mongodb+srv://mehrbanos06:abdulahad@cluster0.nfpgzdy.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0/wine-store"
);
...
app.get("/executivegift", async (_req, res) => {
  let products = await Product.find({});
  let arr = products.splice(0, 4);
  console.log("Executive Gifts");
  res.send(arr);
});
